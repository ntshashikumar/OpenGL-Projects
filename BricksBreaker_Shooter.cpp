...
void screen()
{
	...
	drawstring(250,450,"BOSS");
	drawstring(75,500,"Game Name:");
	drawstring(250,500,"Bricks Breaker");
	drawstring(75,400,"By:");
	drawstring(50,350,"DHANUSH");
	drawstring(150,250,"GUIDE:");
	drawstring(150,200,"Dr.Shreedhara K S");
	drawstring(150,60,"Academic Year:2024-2025");
...
void bricks()
{
	...
	if(b4y1>0)
	{
	b4y1=b4y1-0.02;				//MOVING OF YELLOW BRIKS DOWN
	b4y2=b4y2-0.02;
	}
else
	{
